...
- **Intune enrollment** — Enroll ws01 in Microsoft Intune for endpoint management. Connects to my [Intune case study](https://github.com/DemRamenNoodles/intune-helpdesk-casestudy).
- **Okta AD Agent** — Sync on-prem AD users to Okta for cloud SSO, bridging on-prem identity with cloud identity management.
